// This file was generated by Peginator v0.6.0 built at 1675825801
// CRC-32/ISO-HDLC of the grammar file: 15c8e2b7
...
mod peginator_generated {
    ...
    pub(super) fn parse_ExpressionNode<'a, TT: ParseTracer>(
        ...
        let result = {
            let result =
                ExpressionNode_impl::parse(state, global)?.map(|r| super::ExpressionNode { expr: r.expr, infix: r.infix });
            Ok(result)
        };
        global.tracer.print_trace_result(&result);
        result
